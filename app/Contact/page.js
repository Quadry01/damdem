  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-gray-100 overflow-hidden max-[600px]:p-20">
      ...
      <div className=" absolute left-52 h-3/5  text-center px-20 bg-blue-900 p-8 rounded-lg shadow-lg w-1/4 max-[600px]:w-full max-[600px]:left-0 max-[600px]: ">
        ...
        <form>
          <div className=" text-white text-center text-1xl font-medium mb-2 flex flex-col items-center justify-center">
            <IoCall className=" text-4xl" />
            <Link className="py-2" href="tel:+2348023065560">+2348023065560</Link>
            <Link href="tel:+2348037188153">+2348037188153</Link>
          </div>

          <div className="mb-4 mt-4">
            <label className=" text-white text-center text-1xl font-medium mb-2 flex flex-col items-center justify-center">
              <TfiEmail className=" text-4xl" />
              damdem.system@gmail.com
              <br />
              o_mideolusanya@yahoo.com
              <br />
              sunmboolusanya@yahoo.com
              <br />
            </label>
          </div>
